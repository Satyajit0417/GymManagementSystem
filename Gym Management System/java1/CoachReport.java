...
public class CoachReport extends JInternalFrame {
	...
	public CoachReport() {
		...
		JLabel lblBatchReport = new JLabel("Coach Report ");
		...
		textid.setColumns(1);
		textid.setBounds(206, 161, 128, 31);
		add(textid);
		...
		add(panel1);
           ...
           Connection con;
			...
			System.out.println("Connected_______");
				...
				//para.put("id",textid.getText());
				
			    panel1.removeAll();
			     panel1.repaint();
			     panel1.revalidate();

				InputStream in=new FileInputStream(new File("E:\\java1\\report\\coach.jrxml"));         //G:\\HMSFinalwithout database\\Run\\reports
		...
		JButton btnGenerateReport = new JButton("Find");
		btnGenerateReport.addActionListener(new ActionListener() {
			...
			System.out.println("Connected_______");
				...
				HashMap para = new HashMap();
				para.put("coach_id",textid.getText());
