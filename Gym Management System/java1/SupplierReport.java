...
public class SupplierReport extends JInternalFrame {
	...
	public SupplierReport() {
		...
		JLabel lblBatchReport = new JLabel("supplier Report ");
	...
	JTextField	textsuid = new JTextField();
		//textField.setColumns(10);
		textsuid.setBounds(206, 161, 128, 31);
		add(textsuid);
		...
		add(panel1);
			...
			System.out.println("Connected_______");
			 ...
			 panel1.removeAll();
				...
				InputStream in=new FileInputStream(new File("E:\\java1\\report\\supplier.jrxml"));         //G:\\HMSFinalwithout database\\Run\\reports
				...
				para.put("supp_id",textsuid.getText());
