...
public class BatchReport extends JInternalFrame {
	...
	public BatchReport() {
		...
		JLabel lblBatchReport = new JLabel("Batch Report ");
	...
	JTextField	textbatch = new JTextField();
		//textbatch.setColumns(10);
		textbatch.setBounds(206, 161, 128, 31);
		add(textbatch);
		...
		Connection con;
			...
			System.out.println("Connected_______");
			 ...
			 panel1.removeAll();
				...
				InputStream in=new FileInputStream(new File("E:\\java1\\report\\batch.jrxml"));         //G:\\HMSFinalwithout database\\Run\\reports
		...
		btnGenerateReport.addActionListener(new ActionListener() {
			...
			System.out.println("Connected_______");
			 ...
			 panel1.removeAll();
				...
				JasperReport jr =JasperCompileManager.compileReport(jd);
				HashMap para = new HashMap();
				para.put("batch_no",textbatch.getText());
				JasperPrint j= JasperFillManager.fillReport(jr,para,con);
				//JasperViewer.viewReport(j,false);
				JRViewer v=new JRViewer(j);
				panel1.setLayout(new BorderLayout());
