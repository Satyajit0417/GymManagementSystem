...
public class PurchaseReport extends JInternalFrame {
	...
	//log4j
	final static Logger logger = Logger.getLogger(PurchaseReport.class);
	...
	public PurchaseReport() {
		...
		JLabel lblBatchReport = new JLabel("Purches Report ");
		...
		textinvno.setBounds(206, 161, 128, 31);
		add(textinvno);
		...
		add(panel1);
			...
			System.out.println("Connected_______");
			  ...
			  panel1.removeAll();
				...
				String sql="Select *from purchase order by invoice_no ";
				...
				//para.put("Invoice_no",textinvno.getText());
